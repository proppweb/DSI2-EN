...
import Image2 from "./img/06_Moony-3.jpg";
import Image3 from "./img/06_Moony-4.jpg";
...
<Image src={Image2} alt="Moony" class="py-6 w-full"/>
...
<Image src={Image3} alt="Moony" class="py-6 w-full"/>